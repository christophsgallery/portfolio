...
var cbpAnimatedHeader = (function () {
  ...
  function scrollPage() {
    ...
    if ($(this).scrollTop() > 150) {
      $("#header.fixed-top, #header.show-hide-on-scroll").addClass(
        "header-filled"
      );
    } else {
      $("#header.fixed-top, #header.show-hide-on-scroll").removeClass(
        "header-filled"
      );
    }
    didScroll = false;
...
(function (factory) {
  ...
  Submenupicker.prototype = {
    init: function () {
      ...
      // Bootstrap fix
      this.$menu
        .nextAll(desc + ":first:not(.dropdown-submenu)")
        .children("a")
        .on("keydown", $.proxy(this.next_keydown, this));
    },
...
$(".lightgallery").lightGallery({
  ...
  rotate: false, // If false, disables rotation gesture support.
